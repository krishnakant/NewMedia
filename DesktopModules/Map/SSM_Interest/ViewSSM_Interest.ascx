    ...
    function EmailStringRegualrSeason() {
        ...
        if (tabl.rows.length > 0) {
            ...
            for (i = 1; i < l; i++) {
                ...
                if (flag == true) {
                    regularSeason += "<tr><td style='height:25px;' bgcolor='#D1D1D1'>" + eventName + "</td><td style='height:25px;' bgcolor='#D1D1D1'>" + ofEvent + "</td><td style='height:25px;' bgcolor='#D1D1D1'>" + AvgAttendance + "</td><td style='height:25px;' bgcolor='#D1D1D1'>" + TotalAttendance + "</td></tr>";
                    flag = false;
                    
                }
               else {
                    regularSeason += "<tr><td style='height:25px;' bgcolor='#F8F8F8'>" + eventName + "</td><td style='height:25px;' bgcolor='#F8F8F8'>" + ofEvent + "</td><td style='height:25px;' bgcolor='#F8F8F8'>" + AvgAttendance + "</td><td style='height:25px;' bgcolor='#F8F8F8'>" + TotalAttendance + "</td></tr>";
                    flag = true;
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:RequiredFieldValidator ID="rfvZipCode" runat="server" ControlToValidate="txtZip"
                                                    ErrorMessage="*"></asp:RequiredFieldValidator>
                                                <asp:CompareValidator ID="cvZipCode0" runat="server" ControlToValidate="txtZip" ErrorMessage="*"
                                            ...
                                            <tr valign="top">
                                                <td colspan="2">
                                                    ...
                                                    <asp:UpdateProgress ID="UpdateProgress1" runat="server" AssociatedUpdatePanelID="UpdatePanel2"
                                                        ...
                                                        <ProgressTemplate>
                                                         <br/> 
                                                         <span><b>Email sending&nbsp;&nbsp; </b><img src="/SSM_DNN/Images/progressbar.gif" /></span>
                                                        </ProgressTemplate>
                                                    </asp:UpdateProgress>
                                                </td>
                                            </tr>
