...
<div id="ContentFirstPage">
  <table border="0" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr>
            <td><img alt="" style="width: 20px; height: 30px;" src="/ssm_dnn/portals/3/space.gif" /></td>
        </tr>
        <tr>
            <td>
            <table border="0" cellspacing="2" cellpadding="0">
                <tbody>
                    ...
                    <tr>
                        <td colspan="2" valign="top"><img alt="" style="width: 20px; height:15px;" src="/ssm_dnn/portals/3/space.gif" /></td>
                    </tr>
                    <tr>
