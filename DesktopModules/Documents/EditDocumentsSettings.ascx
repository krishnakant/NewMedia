...
<table width="560" cellspacing="0" cellpadding="0" border="0">
  ...
  <tr valign="top">
    ...
    <td>
      ...
      <asp:Hyperlink ID="lnkEditLists" runat="server" CssClass="CommandButton" style="display: block; padding-bottom: 4px;">List Editor</asp:Hyperlink>
      <asp:Label ID="lblCannotEditLists" runat="server" Visible="false" CssClass="NormalRed"></asp:Label>
    </td>
  </tr>
  <tr valign="top">
    <td class="SubHead" width="200">
