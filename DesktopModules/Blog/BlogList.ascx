...
<div id="BlogContainer" style="padding-top:10PX;">
<span style="font-size:20px;"><strong>BLOG LIST</strong></span>
<br/>
<br/>
 ...
 <HeaderTemplate>
  <asp:Table ID="tblHeader" CellPadding="0" CellSpacing="0" BorderWidth="0" runat="server">
   <asp:TableRow runat="server" ID="trHeader">
    ...
    </asp:TableCell></asp:TableRow></asp:Table><strong>&lt;br/&gt;<br />&lt;br/&gt;<br />&lt;br/&gt;</strong><br />&lt;br/&gt;</HeaderTemplate><FooterTemplate>
  ...
  <asp:Table ID="tblBlogList"  runat="server" BorderWidth="0" CellSpacing="0" CellPadding="0">
   <asp:TableRow runat="server" ID="trBlogList">
    ...
    </asp:TableCell><asp:TableCell runat="server" ID="tdBlogName">
     <asp:HyperLink CssClass="CommandButton" ID="lnkBlog" runat="server" Font-Bold="True" />
    </asp:TableCell><asp:TableCell runat="server" ID="tdBlogRSS" HorizontalAlign="Right">
    ...
    </asp:TableCell></asp:TableRow><asp:TableRow runat="server" ID="trBlogChildren" Visible="False">
    ...
    </asp:TableCell><asp:TableCell runat="server" ID="tdBlogChildren" ColumnSpan="2">
    ...
    </asp:TableCell></asp:TableRow></asp:Table></ItemTemplate></asp:DataList></div>