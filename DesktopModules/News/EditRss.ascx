...
<table cellpadding="4" cellspacing="1">
 ...
 <p style="margin: 20px 0px 0px 0px;">
  <asp:LinkButton runat="server" ID="cmdReturn" resourcekey="cmdReturn" CssClass="CommandButton" CausesValidation="false" />
  <asp:LinkButton runat="server" ID="cmdAdd" resourcekey="cmdAdd" CssClass="CommandButton" CausesValidation="false" />
 </p>
</asp:Panel>
...
<asp:HiddenField runat="server" ID="hidFeedId" />
 ...
 <p style="margin: 20px 0px 0px 0px;">
  <asp:LinkButton runat="server" ID="cmdCancel" resourcekey="cmdCancel" CssClass="CommandButton" CausesValidation="false" />
  <asp:LinkButton runat="server" ID="cmdUpdate" resourcekey="cmdUpdate" CssClass="CommandButton" />
  <asp:LinkButton runat="server" ID="cmdDelete" resourcekey="cmdDelete" CssClass="CommandButton" CausesValidation="false" />
 </p>
</asp:Panel>