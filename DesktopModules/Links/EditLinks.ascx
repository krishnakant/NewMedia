...
<asp:Panel ID="pnlDynamicContent" runat="server">
    <asp:Label ID="plDynamicContent" runat="server" Text="This Module is configured to show dynamic Data. <br /> Please use Modulesettings to change." />
</asp:Panel>
...
<table id="tblGetContent" width="560" cellspacing="0" cellpadding="0" enableviewstate="false"
    ...
    <tr>
        <td class="SubHead" width="160">
            <dnn:Label ID="plGetContent" runat="server" ControlName="txtGetContent" Suffix=":">
            </dnn:Label>
        </td>
        <td width="365">
