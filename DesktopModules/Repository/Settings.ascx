...
<TABLE cellSpacing="0" cellPadding="2" border="0" class="normal">
	...
	<tr>
		<td valign="top">
			<dnn:label id="plIsPersonal" runat="server" controlname="cbxIsPersonal" suffix=":"></dnn:label><br />
			<asp:CheckBox ID="cbxIsPersonal" runat="server" Checked="false" CssClass="normal" Text="" />
			<br />
			<br />
			<br />
		</td>
    ...
    <tr>
		<td valign="top">
			<dnn:label id="plEmailOnUpload" runat="server" controlname="cbxEmailOnUpload" suffix=":"></dnn:label><br />
    ...
    <tr>
		<td valign="top">
			<dnn:label id="plEmailOnComment" runat="server" controlname="cbxEmailOnComment" suffix=":"></dnn:label><br />
	...
	<tr style="display: none;">
		<td valign="top">
			<dnn:label id="plDataControl" runat="server" controlname="rblDataControl" suffix=":"></dnn:label><br />
	...
	<tr>
		<td valign="top">
			<dnn:label id="plWatermark" runat="server" controlname="txtWatermark" suffix=":"></dnn:label><br />
	...
	<tr id="FileLocationRow" runat="server" visible="false">
		<td valign="top">
