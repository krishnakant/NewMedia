   ...
   <tr>
                      ...
                      <asp:DataGrid ID="dgItems" runat="server"
                        ...
                        <Columns>
		                   ...
		                   <asp:TemplateColumn HeaderText="IsActive">
						        ...
						        <ItemTemplate>
							        <asp:Image runat="server" AlternateText='' ImageUrl='<%# IIf(DataBinder.Eval(Container.DataItem, "IsActive") = 1, "~/images/checked.gif", "~/images/unchecked.gif") %>' ID="Image2"/>
						        </ItemTemplate>
						    </asp:TemplateColumn>
		              </Columns>
		                  </asp:DataGrid>
        ...
        <td style="width:60%;">
            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="text-align:left;">
                ...
                <tr>
                    <td colspan="2" style="text-align:left; padding-top: 6px">
