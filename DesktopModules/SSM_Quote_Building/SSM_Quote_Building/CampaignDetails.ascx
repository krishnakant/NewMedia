    ...
    <div class="subcontainer">
        ...
        <div class="ouraudience_content">
            <table class="googlemap" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td>
                        <img alt="" style="width: 20px; height: 30px;" src="/ssm_dnn/portals/1/space.gif" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <img alt="" style="width: 20px; height: 10px;" src="/ssm_dnn/portals/1/space.gif" />
                    </td>
                </tr>
                <tr>
                    <td>
                                ...
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td colspan="2" style="height: 25px;">
                                            <img alt="" style="width: 20px; height: 15px;" src="/ssm_dnn/portals/1/space.gif" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="height: 25px;">
                                    ...
                                    <tr>
                                        <td colspan="2" style="height: 25px;">
                                            <img alt="" style="width: 20px; height: 3px;" src="/ssm_dnn/portals/1/space.gif" />
                                        </td>
                                    </tr>
                                </table>
