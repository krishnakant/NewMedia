   ...
   partial class ViewSSM_Interest : PortalModuleBase, IActionable
    {
            ...
            try
            {
                ...
                if (result==true)
                {
                    ...
                    foreach (DataRow r in dtHosted.Rows)
                    {
                        if (desingFlage == true)
                        {
                            hostedTournament += "<tr style='height:25px;' bgcolor='#D1D1D1'><td>" + r[1].ToString() + "</td><td>" + r[2].ToString() + "</td><td align='center'>" + r[3].ToString() + "</td><td align='center'>" + r[4].ToString() + "</td><td align='center'>" + r[5].ToString() + "</td></tr>";
                            desingFlage = false;
                        }
                        else
                        {
                            hostedTournament += "<tr style='height:25px;' bgcolor='#F8F8F8'><td>" + r[1].ToString() + "</td><td>" + r[2].ToString() + "</td><td align='center'>" + r[3].ToString() + "</td><td align='center'>" + r[4].ToString() + "</td><td align='center'>" + r[5].ToString() + "</td></tr>";
                            desingFlage = true;
                        }
                    ...
                    if (flag == true)
                    {
                        ...
                        emailTemplet += "<tr><td><hr></hr></td></tr>";
                        emailTemplet += "</table>";
                        SendEmail("krishnabatham@gmail.com", "krishna.batham@systematixindia.com", "", "", "Enrolling Details", emailTemplet);
       ...
       //Method to send email
        ...
        {
            bool validation;
            if (txtFirstName.Text != "" && txtLastName.Text != "" && txtYourTitle.Text != "" && txtEmailAddress.Text != "" && txtPhoneNo.Text != "" && txtSchoolName.Text != "" && txtSchoolAddress.Text != "" && txtSchoolDistrict.Text != "" && txtCity.Text != "" && txtZip.Text != "" && txtConferenceName.Text != "")
                validation = true;
            else
                validation = false;
            return validation;
