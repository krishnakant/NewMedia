        ...
        <td valign="top" width="500">
            <table id="tblADSettings" cellspacing="0" cellpadding="1" border="0">
                ...
                <tr id="rowAutoCreate" runat="server">
                    ...
                    <td valign="top" nowrap><asp:CheckBox ID="chkAutoCreate" runat="server" CssClass="NormalTextBox" /></td>
                </tr>
                <tr>
                ...
                <tr id="rowRootDomain" runat="server">
                    ...
                    <td valign="top" nowrap><asp:TextBox ID="txtRootDomain" runat="server" CssClass="NormalTextBox" Width="300px" /></td>
                </tr>
                <tr id="rowUserName" runat="server">
                    ...
                    <td valign="top" nowrap><asp:TextBox ID="txtUserName" runat="server" CssClass="NormalTextBox" Width="300px" /></td>
                </tr>
                <tr id="rowPassword" runat="server">
                    ...
                    <td valign="top" nowrap><asp:TextBox ID="txtPassword" runat="server" CssClass="NormalTextBox" Width="300px" TextMode="Password" /></td>
                </tr>
                ...
                <tr id="rowEmailDomain" runat="server">
                    ...
                    <td valign="top" nowrap><asp:TextBox ID="txtEmailDomain" runat="server" CssClass="NormalTextBox" Width="300px" /></td>
                </tr>
                <tr id="rowDefaultDomain" runat="server">
                    ...
                    <td valign="top" nowrap><asp:TextBox ID="txtDefaultDomain" runat="server" CssClass="NormalTextBox" Width="300px" /></td>
                </tr> 
                <tr id="rowSubNet" runat="server">
                    ...
                    <td valign="top" nowrap><asp:TextBox ID="txtAutoIP" runat="server" CssClass="NormalTextBox" Width="300px" Height="72px" TextMode="MultiLine" /></td>
                </tr>
            </table>
        </td>
    </tr>
