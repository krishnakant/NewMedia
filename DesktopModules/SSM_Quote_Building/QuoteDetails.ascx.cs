      ...
      public string strSMTP = DotNetNuke.Entities.Host.HostSettings.GetHostSetting("SMTPServer");
        ...
        protected void btnFinish_Click(object sender, EventArgs e)
        {
            ...
            if (combineData != "")
            {
                ...
                if (dataPart[1] != "")//used when quotation mode is (complete network)
                {
                 ...
                 if (Session["GmapContentForEmail"] != "" && Session["GmapContentForEmail"]!=null)
                 {
                     ...
                     emailTemplet += "<tr><td></br></td></tr>";
                     emailTemplet += "<tr><td style='padding-top:10px;font-size:11.0pt;font-family:&quot;Calibri&quot;,&quot;sans-serif&quot;'><img style='width:13px; min-height: 20px; height: 20px;' src='http://216.197.113.107/ssm_dnn/Portals/3/marker.gif'></img>school include in quote";
